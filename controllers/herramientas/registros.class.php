	 ...
	 function loadContent(){
	  ...
	  function Buscar(){
		...
		foreach($this->Model->fichas as $row){
			 ...
			 $recurso .= '<tr>
								<td ><h3>'.htmlentities($row['APLICACION'], ENT_QUOTES, "ISO-8859-1").'</h3></td>
								<td><h3>'.htmlentities($row['MODULO'], ENT_QUOTES, "ISO-8859-1").'</h3></td>
								<td><h3>'.htmlentities($row['MENSAJE'], ENT_QUOTES, "ISO-8859-1").'</h3></td>
								<td><h3>'.htmlentities($row['PK_USUARIO'], ENT_QUOTES, "ISO-8859-1").'</h3></td>
								<td><h3>'.htmlentities($row['FECHA_R']->format('Y-m-d'), ENT_QUOTES, "ISO-8859-1").'</h3></td>
							</tr>';
			}	
