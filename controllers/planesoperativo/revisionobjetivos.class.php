       ...
       $panelcontent .='<!--====================OBJETIVO=====================--> 
		<div class="wellwhite" id="L'.$cont.'-C'.$contobjetivo.'">
			<table width="100%" '.$ocultar.'>
				<tr>
					<td></td>
					<td bgcolor="#D9D9D9" style="color:#000; padding:5px; background-color: #D9D9D9; font-size:12px; font-weight: bold;" colspan="2">Resultado</td>
					<td width="400px;" bgcolor="#D9D9D9" style="color:#000; background-color: #D9D9D9; padding:5px; font-size:12px; font-weight: bold;">Objetivo Estratégico</td>
					<td width="200px;" bgcolor="#D9D9D9" style="color:#000; padding:5px; background-color: #D9D9D9; font-size:12px; font-weight: bold;">Responsable</td>
				</tr>
				<tr>
					<td style="color:#000; padding:5px;  font-size:11px;" align="right">'.$cont.'.'.$contobjetivo.'</td>
					<td style="color:#000; padding:5px;  font-size:11px;" colspan="2">'.htmlentities($rowobj['OBJETIVO'], ENT_QUOTES, "ISO-8859-1").'</td>
					<td style="color:#000; padding:5px; font-size:11px;">'.htmlentities(($rowobjes['OBJETIVO']), ENT_QUOTES, "ISO-8859-1").'</td>
					<td style="color:#000; padding:5px;  font-size:11px;">'.htmlentities($this->Model->getResponsable($rowobj['PK_RESPONSABLE']),ENT_QUOTES, "ISO-8859-1").'</td>
				</tr>
			</table>
		<div class="box-icon" '.$ocultar.'>';
	  
			$this->Model->getIndicadoresByObj($rowobj['PK1'],$rowobjes['PK1']);
			$numIndicadoresO = sizeof($this->Model->indicadoresO); 
			$panelcontent .= '<span style="float:left; position:relative; left:10px;" class="notification">'.$numIndicadoresO.'</span>
					<a href="javascript:void(0)" onclick="Toogle(this);" class="btn btn-minimize btn-round" id="TOG-L'.$cont.'-IO'.$contobjetivo.'"><i class="icon-chevron-down"></i> Indicadores de Objetivo</a>						
		</div>
		<div class="box-objectivos" style="display:none;" id="BOX-L'.$cont.'-IO'.$contobjetivo.'">
    	...
    	<div>
			<table width="100%">
				...
				<td width="10px;"></td>
				<td width="100px;"></td>
				<td colspan="1" bgcolor="#D9D9D9"  style="color:#000; background-color: #D9D9D9; padding:5px; font-size:12px; font-weight: bold;">Indicador de Objetivo</td>
				<td bgcolor="#D9D9D9" width="200px;" style="color:#000; padding:5px; background-color: #D9D9D9; font-size:12px; font-weight: bold;">Meta al 2024</td>
				</tr>';
								
			$contIndicadorO = 1;
			$loopcontIndicadorO = 0;
			if($numIndicadoresO != 0){
				foreach($this->Model->indicadoresO as $rowmindicadoresO){
					$script .='
					lineas_objetivos_medios['.$loop.']['.$loopobjetivo.']['.$loopcontIndicadorO.'] = "1";';	
					$panelcontent .='<tr id="L'.$cont.'-O'.$contobjetivo.'-M'.$contIndicadorO.'-C'.$contobjetivo.'">
										<td></td>
										<td  align="right" style=" float:right;  padding:5px; font-size:11px; ">'.$contIndicadorO.'</td>
										<td colspan="1"  style="background-color:#FFCC99;  padding:5px; font-size:11px; ">'.htmlentities($rowmindicadoresO['INDICADOR'], ENT_QUOTES, "ISO-8859-1").'</td>
										<td  style="background-color:#FFCC99; padding:5px;  font-size:11px; ">'.htmlentities($rowmindicadoresO['META'], ENT_QUOTES, "ISO-8859-1").'</td>
									</tr>';
					$contIndicadorO++;
					$loopcontIndicadorO++;
				}
		...
		<div class="box-icon" '.$ocultar.'>';
			...
			$panelcontent .= '<span style="float:left; position:relative; left:10px;" class="notification">'.$nummedios.'</span>
					<a href="javascript:void(0)" onclick="Toogle(this);" class="btn btn-minimize btn-round" id="TOG-L'.$cont.'-C'.$contobjetivo.'"><i class="icon-chevron-down"></i> Medios</a>						
		</div>
	...
	<div>
		<table width="100%">
			<tr>
				<td></td>
				<td width="100px;"></td>
				<td colspan="1" bgcolor="#D9D9D9"  style="color:#000; background-color: #D9D9D9; padding:5px; font-size:12px; font-weight: bold;">Indicadores de Resultado</td>
				<td  style="color:#000; background-color: #D9D9D9; padding:5px; font-size:12px; font-weight: bold;">Meta Anual</td>
			</tr>
			';
			...
			$contindicadoresMeta = 1;
			$loopindicadoresMeta = 0;
			if($numindicadoresMeta != 0){
				
				
				foreach($this->Model->indicadoresMeta as $rowindicadoresMeta){
				$script .='
				lineas_objetivos_evidencias['.$loop.']['.$loopobjetivo.']['.$loopindicadoresMeta.'] = "1";
				';	           
			
			$panelcontent .= '
			<tr id="L'.$cont.'-O'.$contobjetivo.'-E'.$contindicadoresMeta.'-C'.$contobjetivo.'">
				<td></td>
				<td  align="right" style="color:#000; float:right;  padding:5px; font-size:11px; ">'.$cont.'.'.$contobjetivo.'.'.$contindicadoresMeta.'</td>
				<td colspan="1"  style="color:#000;  padding:5px; font-size:11px; ">'.htmlentities($rowindicadoresMeta['INDICADOR'], ENT_QUOTES, "ISO-8859-1").'</td>
				<td  style="color:#000; padding:5px;  font-size:11px; ">'.htmlentities($rowindicadoresMeta['META'], ENT_QUOTES, "ISO-8859-1").'</td>
			</tr>';
    	...
    	<div>
			<table width="100%">
				...
				<td width="10px;"></td>
				<td width="100px;"></td>
				<td colspan="2" bgcolor="#D9D9D9"  style="color:#000; background-color: #D9D9D9; padding:5px; font-size:12px; font-weight: bold;">Medios</td>
				<td bgcolor="#D9D9D9" width="200px;" style="color:#000; padding:5px; background-color: #D9D9D9; font-size:12px; font-weight: bold;">Responsable</td>
				</tr>';
			...
			if($nummedios != 0){
				foreach($this->Model->medios as $rowmedios){
					...
					$panelcontent .='<tr id="L'.$cont.'-O'.$contobjetivo.'-M'.$contmedio.'-C'.$contobjetivo.'">
										<td></td>
										<td  align="right" style="color:#000; float:right;  padding:5px; font-size:11px; ">'.$cont.'.'.$contobjetivo.'.'.$contmedio.'</td>
										<td colspan="2"  style="color:#000;  padding:5px; font-size:11px; ">'.htmlentities($rowmedios['MEDIO'], ENT_QUOTES, "ISO-8859-1").'</td>
										<td  style="color:#000; padding:5px;  font-size:11px; ">'.htmlentities($this->Model->getResponsable($rowmedios['PK_RESPONSABLE']), ENT_QUOTES, "ISO-8859-1").'</td>
									</tr>';
					$contmedio++;
					$loopmedio++;
				}
		...
		<table width="100%">
			<tr>
				<td width="10px;"></td>
				<td width="100px;"></td>
				<td colspan="2" bgcolor="#D9D9D9"  style="color:#000; background-color: #D9D9D9; padding:5px; font-size:12px; font-weight: bold;">Evidencias</td>
				<td></td>
			</tr>
			';
