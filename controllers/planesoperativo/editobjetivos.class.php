 ...
 if(isset($_GET['IDPlan'])){
	...
	function error(){
	 ...
	 function loadContent(){
		...
		if ($this->isAdm || in_array('P45',$this->permisosArray) ) {
...
/* <tr>
		 <td colspan="2" style="color: #e68376;  font-size:14px; font-weight: bold; ">Análisis Interno</td>
		 </tr>
		 <tr><td >&nbsp; </td></tr> 
		 */
      ...
      //Áreas de oportunidad(Debilidades)
       $htmLcontent .= ' <div class="well">
		...
		/*
		  <tr>
		 <td colspan="2" style="color: #e68376;  font-size:14px; font-weight: bold; ">Análisis Externo</td></tr>
		 <tr>
		 <tr><td >&nbsp; </td></tr> 
	...
	$htmLcontent .= '
         ...
         <table width="100%" id="OPORTUNIDADEST">
         <tbody>
...
//---------------AMENAZAS(*Debilidades(*)error)-------------------
	...
	$htmLcontent .= '  <div class="well" >
      ...
      //	fin nuevo	
		    ...
		    $script .='
			$(".area").Watermark("Agrega debilidad...");
							...
							if($this->valExistInColumn($this->Model->indicadoresO,"PK_INDICADORMETA",$rowObjInd['PK1'])){
								...
								<div class="input-prepend INDdiv'.$disabledIndicador.'" style="width:95%;background: #dd5600;border-bottom: 1px solid #BBBBBB;padding:4px;border-radius:4px;">
									<span id="textindicador111" class="" style="display: inline-block;">';
										...
										$panelcontent .= '<span class="add-on" style="margin-top: -9px;">'.$cont.'.'.$contObjEstrategico.'.'.($rowObjInd['ORDEN']+1).'</span>';
										$panelcontent .= '</span>
								...
								$panelcontent .= '									   
								<div class="input-prepend INDdiv'.$disabledIndicador.'" style="width:95%;background: #ffffff;border-bottom: 1px solid #BBBBBB;padding:4px;border-radius:4px;">
									<span id="textindicador111" class="" style="display: inline-block;">';
	...
	<div class="box-icon">
		...
		<a href="javascript:void(0)" onclick="Toogle(\''.$rowobj['PK1'].'\',this);" class="btn btn-minimize btn-round" id="TOG-'.$rowobj['PK1'].'"><i class="icon-chevron-down"></i> Medios, Evidencias e Indicadores-Metas (anuales)</a>	
	</div>  
