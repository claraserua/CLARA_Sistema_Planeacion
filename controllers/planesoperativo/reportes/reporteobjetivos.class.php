<?php
include "models/planesoperativo/reportes/reporteobjetivos.model.php";



class reporteobjetivos {
	...
	function reporteobjetivos() {
	 ...
	 $this->Model = new reporteobjetivosModel();
	...
	function error(){
	 ...
	 function loadContent(){
		...
		$contenido = $this->View->Template(TEMPLATE.'modules/reportes/po/REPORTEOBJETIVOS.TPL');
		...
		$numplanes = sizeof($this->Model->planes); 
		 ...
		 if($numplanes != 0){
		  ...
		  foreach($this->Model->planes as $plan){		  	
		    ...
		    $html.='<td  style="border:1px #999999 solid; background:#CCC; color:#333;" width="5%"><strong>No. Objetivos</strong></td>';
		 	$html.='<td  style="border:1px #999999 solid; background:#CCC; color:#333;" width="5%"><strong>No. Resultados</strong></td>';
		 	
		 	$html.='<td  style="border:1px #999999 solid; background:#CCC; color:#333;" width="5%"><strong>No. Medios</strong></td>';		 	
		 	
		 	$html.='<td  style="border:1px #999999 solid; background:#CCC; color:#333;" width="5%"><strong>% avance objetivo</strong></td>';
		 	$html.='<td  style="border:1px #999999 solid; background:#CCC; color:#333;" width="5%"><strong>% avance Resultados</strong> </th>';
		 	
		 	$html.='<td  style="border:1px #999999 solid; background:#CCC; color:#333;" width="5%"><strong>% avance Medios</strong> </th>';
		 	
		 	$html.='<td  style="border:1px #999999 solid; background:#CCC; color:#333;" width="5%"><strong>No. Objetivos sin Avance</strong> </th>';
		 	...
		 	$numperiodos = sizeof($this->Model->periodos);
		 	   if($numperiodos != 0){
		 	    ...
		 	    $html.='<td  style="border:1px #999999 solid; background:#CCC; color:#333;" width="40px" ><strong>%Promedio de avance Resultado '.htmlentities($periodo['PERIODO'], ENT_QUOTES, "ISO-8859-1").'</strong></td>'; 	
		 	...
		 	$html.='</tr>';
		 	      ...
		 	      if($numlineas != 0){
					 ...
					 //  $y=0;//num res	
			          ...
			          $html.='<td style=" text-align: center; border:1px #999999 solid; font-size:14px;">'.$this->Model->getNumObjetivosEst($plan['PK1'],$linea['PK1']).'</td>'; 
								
						  $html.='<td style="text-align: center;  border:1px #999999 solid; font-size:14px;">'.$this->Model->getNumResultados($plan['PK1'],$linea['PK1']).'</td>'; 
						  
						    $html.='<td style="text-align: center;  border:1px #999999 solid; font-size:14px;">'.$this->Model->getNumMedios($plan['PK1'],$linea['PK1']).'</td>'; 
									
						$html.='<td style="text-align: center;  border:1px #999999 solid; font-size:14px;">'.$this->Model->getPorcAvancesObjetivos($plan['PK1'],$linea['PK1']).'</td>'; 
										
						$html.='<td style="text-align: center;  border:1px #999999 solid; font-size:14px;">'.$this->Model->getPorcAvancesResultados($plan['PK1'],$linea['PK1']).'</td>'; 
						
						$html.='<td style="text-align: center;  border:1px #999999 solid; font-size:14px;">'.$this->Model->getPorcAvancesMedios($plan['PK1'],$linea['PK1']).'</td>'; 
						
						
						$html.='<td style="text-align: center;  border:1px #999999 solid; font-size:14px;">'.$this->Model->numObjSinAvance.'</td>'; 		
