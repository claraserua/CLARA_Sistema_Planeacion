	...
	function error(){
	 ...
	 function loadContent(){
		...
		foreach($this->Model->lineas as $row){
		    ...
		    $lineas .= "<option value=\"".$row['PK1']."\">".$i++.".- ".htmlentities($row['LINEA'])."</option>";
    ...
    $panelcontent .='</select>
	 ...
	 &nbsp;&nbsp;<small>Resultado:</small>
	  <select name="objetivosfilter" id="objetivosfilter" disabled="disabled" onchange="filterObjetivo(this);"  style="width:80%; z-index:1000;">
		...
		<a class="btn btn-small btn-warning" type="button" href="?execute=planesoperativo/exportresp/exportexcel&IDPlan='.$_GET['IDPlan'].'&IDPlanE='.$_GET['IDPlanE'].'"><i class="icon-upload icon-white"></i> Exportar</a>
							                ';
                    ...
                    <div class="left">  
                         ...
                         <div id="toolbar"><a class="" href="#" onClick="buscar()">Lineas</a></div>
	                    </div> 
