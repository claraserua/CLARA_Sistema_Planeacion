<?php
include "models/historicope.model.php";
...
class historicope {
	...
	$this->View->replace_content('/\#NODOS\#/ms' ,$nodos);
	 ...
	 function loadContent(){
	  ...
	  $section = TEMPLATE.'modules/planestrategico/GRDPLANH.TPL';
	  $section = $this->View->loadSection($section);
					...
					if($this->passport->privilegios->hasPrivilege('P36')){
								...
								$recurso .='  <li><a href="mailto:info@example.com?subject=\'Plan Estratégico:'.htmlentities($row['TITULO'], ENT_QUOTES, "ISO-8859-1").' \'&body='.$body.'" ><i class="icon-envelope"></i> Compartir</a></li>
								  <li class="divider"></li>';
								   ...
								   if($this->passport->privilegios->hasPrivilege('P009')){		
								 $recurso .= '<li><a href="#" onClick="javascript:DesArchivarPlanEstrategico(\''.$row['PK1'].'\',false);return false;"><i class="icon-arrow-left"></i> Desarchivar</a></li>';
									}
