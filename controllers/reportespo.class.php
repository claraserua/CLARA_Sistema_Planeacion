	  ...
	  $section =  $this->View->replace('/\#REPORTESPOA\#/ms' ,"",$section);
	   ...
	   $urlcadena ='<tr>
					 ...
					 <td>
						   ...
						   onmouseover="this.style.color=\'#E75900\'" onmouseout="this.style.color=\'#000000\'">Resumen avance POA </a></font></strong>
						   </div>
						   <div>
						   <i>
					Permite descargar un resumen de los avances del Plan Operativo.
						   </i>
						   </div>
						   </div>
...
//Reporte avances POA
	   $urlcadena ='<tr>
					 ...
					 <td>
						   ...
						   <div style="border-bottom: 1px solid #E75900; padding-bottom: 5px;">
						   <strong>
						   <font size="3"><a href="?execute=planesoperativo/reportes/indicadores&method=default&Menu=F2&SubMenu=SF23#&p=1&s=25&sort=1&q=&opt=indicadores"
						   onmouseover="this.style.color=\'#E75900\'" onmouseout="this.style.color=\'#000000\'">Reporte Indicadores POA</a></font></strong>
						   </div>
						   <div>
						   <i>
					Permite descargar un Reporte de indicadores POA.
						   </i>
						   </div>
						   </div>
	  ...
	  $section =  $this->View->replace('/\#REPORTEINDICADORESPOA\#/ms' ,$urlcadena,$section);
	  }else{
	  $section =  $this->View->replace('/\#REPORTEINDICADORESPOA\#/ms' ,"",$section);
	  }
	  ...
	  $section =  $this->View->replace('/\#REPORTESINFORMESPOA\#/ms' ,"",$section);  
	   ...
	   $urlcadena ='<tr>
						   ...
						   onmouseover="this.style.color=\'#E75900\'" onmouseout="this.style.color=\'#000000\'">Reporte general de avances 1</a></font></strong>
						   </div>
						   <div>
						   <i>
					 reporte general de avances 1(POA)
						   </i>
						   </div>
						   </div>
	  ...
	  $section =  $this->View->replace('/\#REPORTESUSUARIOPOA\#/ms' ,"",$section);
	   ...
	   $urlcadena ='<!--cambio i-->
						   ...
						   onmouseover="this.style.color=\'#E75900\'" onmouseout="this.style.color=\'#000000\'">Reporte general de avances 2</a></font></strong>
						   </div>
						   <div>
						   <i>
					reporte general de avances 2(POA)
						   </i>
						   </div>
						   </div>
