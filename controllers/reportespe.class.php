	 ...
	 function loadContent(){
	  ...
	  $section = $this->View->loadSection($section);
	   ...
	   $urlcadena =' <tr>
						   ...
						   <strong>
						   <font size="3"><a href="?execute=planestrategico/reportes/reportes&method=default&Menu=F1&SubMenu=SF13#&p=1&s=25&sort=1&q="
						   onmouseover="this.style.color=\'#E75900\'" onmouseout="this.style.color=\'#000000\'">Reportes PE</a></font></strong>
						   </div>
						   <div>
						   <i>
					Esta funcionalidad le permite descargar reportes de Planes Estrat&eacute;gicos.
						   </i>
						   </div>
						   </div>
	   ...
	   if($this->passport->privilegios->hasPrivilege('P210')){
	  $section =  $this->View->replace('/\#REPORTESPE\#/ms' ,$urlcadena,$section);
	  }else{
	  $section =  $this->View->replace('/\#REPORTESPE\#/ms' ,"",$section);
	  }
	  
	  
	    //Reporte de Avances del Plan Estratégico
	   $urlcadena ='		
							<tr>
						   ...
						   <div style="border-bottom: 1px solid #E75900; padding-bottom: 5px;">
						   <strong>
						   <font size="3"><a href="?execute=planestrategico/reportes/avances&method=default&Menu=F1&SubMenu=SF13#&p=1&s=25&sort=1&q=" 
						   onmouseover="this.style.color=\'#E75900\'" onmouseout="this.style.color=\'#000000\'">Reporte de Avances del Plan Estrat&eacute;gico</a></font></strong>
						   </div>
						   <div>
						   <i>
				  Genere un avances del Plan Estrat&eacute;gico.
						   </i>
						   </div>
						   </div>
	   ...
	   if($this->passport->privilegios->hasPrivilege('P211')){
	  $section =  $this->View->replace('/\#REPORTESAVANCESPE\#/ms' ,$urlcadena,$section);
	  }else{
	  $section =  $this->View->replace('/\#REPORTESAVANCESPE\#/ms' ,"",$section);
	  }
