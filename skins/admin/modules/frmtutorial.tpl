<script src="skins/admin/js/tutoriales.js" type="text/javascript"></script>
...
<input type="hidden" name="idarticulo" id="idarticulo" value="#IDARTICULO#" />                
				               ...
				               CKEDITOR.replace( 'txtdescripcion',
					{
						...
						<fieldset>
                            ...
                            Establecer el tutorial como disponible<br /><br />
                            &nbsp; &nbsp; <input type="checkbox" name="checkprivado" id="checkprivado"  #PRIVADO#  />
                            Establecer el tutorial como privado<br /><br />
