	...
	({
		...
		//alert(response);
			...
			else
			{
				...
				$.unblockUI();
				$('#alerta')
					.html('El articulo ha sido guardado correctamente.')
					.removeClass()
...
var id = id;
var eliminar = confirm("¿Esta seguro de eliminar este articulo?");
if(eliminar){
//$("#status").html('Loading.....');
$.ajax({ 
    type: "GET",  
    url: "index.php",  
    data: "execute=articulos&handle=articulos&action=get&method=deleteArticulo&id="+id,  
    success: function(msg){  
