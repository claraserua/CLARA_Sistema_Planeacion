...
function EliminarUsuario(file,id,confirm){
      
	 if(!confirm){
	 $('#titlemodal').html('Eliminar Usuario');
	 $('#bodymodal').html('¿Esta seguro de eliminar el usuario:<strong> '+id+'</strong>?');
	  $("#aceptarmodal").attr("onClick", "javascript:EliminarUsuario('"+file+"','"+id+"',true);return false;")
    ...
    url: "index.php?execute=usuarios&method=Eliminar",  
