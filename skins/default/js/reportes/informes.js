  ...
  function buscar(fil){
   ...
   $('div.box-content').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
	...
	$.ajax({ 
    type: "POST",  
    url: "?execute=planesoperativo/reportes/informes&method=Reporte&nodos="+nodos+"&anos="+anos,     
    ...
    $('div.box-content').html(msg);
     ...
     $("#descargarE").attr("href", "?execute=planesoperativo/reportes/descargar_informes&nodos="+nodos+"&anos="+anos);
