  ...
  function buscar(fil){
   ...
   $('div.box-content').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
	...
	$.ajax({ 
    type: "POST",  
    url: "?execute=planestrategico/reportes/avances&method=Reporte&nodos="+nodos+"&anos="+anos,  
    ...
    success: function(msg){  
     ...
     $("#descargarE").attr("href", "?execute=planestrategico/reportes/descargar_avances&nodos="+nodos+"&anos="+anos);
