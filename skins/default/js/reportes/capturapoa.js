  ...
  function buscar(fil){
   ...
   $('div.box-content').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
	...
	$.ajax({ 
    type: "POST",  
    url: "?execute=planesoperativo/reportes/capturapoa&method=Reporte&nodos="+nodos+"&anos="+anos,  
    ...
    $("#descargarE").attr("href", "?execute=planesoperativo/reportes/descargar_capturapoa&nodos="+nodos+"&anos="+anos);
