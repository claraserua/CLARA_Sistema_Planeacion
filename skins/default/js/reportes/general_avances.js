  ...
  function buscar(fil){
   ...
   $('div.box-content').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
	...
	$.ajax({ 
    type: "POST",  
    url: "?execute=planesoperativo/reportes/generalavances&method=Reporte&nodos="+nodos+"&anos="+anos,    
    success: function(msg){ 

    
    $('div.box-content').html(msg);
    
     $("#descargarE").attr("href", "?execute=planesoperativo/reportes/descargar_general_avances&nodos="+nodos+"&anos="+anos);
