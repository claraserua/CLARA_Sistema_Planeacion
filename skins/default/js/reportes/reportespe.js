  ...
  function buscar(fil){
   ...
   $('div.box-content').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
	...
	$.ajax({ 
    type: "POST",  
    url: "?execute=planestrategico/reportes/reportes&method=Reporte&nodos="+nodos+"&anos="+anos,  
   ...
   $('div.box-content').html(msg);
     ...
     $("#descargarE").attr("href", "?execute=planestrategico/reportes/descargar_reportes&nodos="+nodos+"&anos="+anos);
