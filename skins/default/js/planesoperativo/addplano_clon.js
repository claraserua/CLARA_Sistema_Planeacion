...
function GuardarPlanOperativo(){
	 ...
	 var idplan_clonar = $('#idplan_clonar').val();	
    ...
    type: "POST",  
    url: "index.php?execute=planesoperativo/addplano_clon&Menu=F1&SubMenu=SF4&method=GuardarPlan",  
    data: { titulo: titulo, descripcion: descripcion, disponible : disponible, finicio:finicio, ftermino:ftermino,seguimiento:seguimiento, IDPlanEstrategico:idplanE, idplan:idplan,jerarquia:jerarquia,idplan_clonar:idplan_clonar},  
