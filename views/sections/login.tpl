<div class="loginpanel">
    <div class="loginpanelinner">
       ...
       PLANEACIÓN Ver. 2.0  <br><small><span class="icon-info-sign"></span>Cloud Application Red Anáhuac</small></div>
        ...
        <form id="login" action="web.php" method="post" autocomplete="off">
            ...
            <div style="width:100%;">
					<div class="SF_element">
						...
						<div class="SF_input"><input type="text" placeholder="Login" class="dialogFocus" style="width: 100px; padding:0px;" name="usuario" id="usuario" required></div>
					</div>
					<div class="SF_element">
						<div class="SF_label"><ajxp:message ajxp_message_id="182">Password</ajxp:message></div>
						<div class="SF_input"><input type="password" placeholder="Password" style="width: 100px; padding:0px;" name="password" id="password" required></div>
					</div>
					<div class="SF_element">
