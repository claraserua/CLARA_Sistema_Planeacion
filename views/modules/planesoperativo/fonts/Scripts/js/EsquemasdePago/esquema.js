...
$(function () {
    ...
    */
    ...
    $(window).load(function () {
        ...
        //formValidation.notEmpty('niveles', 'El campo esquema no debe de estar vacio');
        formValidation.notEmpty('tipocontrato', 'El campo esquema no debe de estar vacio');
        //formValidation.notEmpty('fechai', 'El campo esquema no debe de estar vacio');
        //formValidation.notEmpty('fechaf', 'El campo esquema no debe de estar vacio');
...
var formPage = function () {
    ...
    "use strict"; return {
       ...
       /* ConsultaPeriodos: function () {
            ...
            var ClaveCiclo = $('#anios').val();

            var model = {
                claveanio: ClaveCiclo
            }
          
            $.ajax({
                type: "POST",
                cache: false,
                url: "/Esquemas/ConsultaPeriodos",
                data: model,
                success: function (data) {                  
                    $('#periodos').html(data.periodos);
                },
                error: function (data) { }
            });
        },*/
        ...
        edit: function (id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                	...
                	// $("#periodos option[value=" + data.periodos + "]").attr("selected", true);
