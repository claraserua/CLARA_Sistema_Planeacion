...
class comentariosModel {
	...
	function getComentarios($id){
	 ...
	 function getComentariosResumenSeguimiento($idoperativo,$idperiodo){
		
		$this->comentarios = array(); 
		$sql = "SELECT * FROM PL_POPERATIVOS_RESUMENE_COMENTARIOS_SEGUIMIENTO WHERE PK_POPERATIVO = '$idoperativo' AND PK_PERIODO = '$idperiodo' ORDER BY FECHA_R DESC";	
