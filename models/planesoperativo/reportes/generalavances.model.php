...
class generalavancesModel {
	...
	function getAvanceMedio($medio,$periodo){
		
		$sql = "SELECT PORCENTAJE FROM PL_POPERATIVOS_MEDIOS_AVANCES WHERE PK_MEDIO='$medio' AND PK_PERIODO = '$periodo'";
