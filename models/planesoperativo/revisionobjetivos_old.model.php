...
class revisionobjetivosModel {
	...
	function revisionobjetivosModel() {
...
<div style="margin-top:20px;font-family:\'Segoe UI\', Tahoma, sans-serif; font-size:10pt; line-height:13pt; color:#000;"> 
                  ...
                  <li>Todos los usuarios del centro pueden ver los comentarios de los resultados.</li>
                    <li>Sólo los usuarios con permiso pueden editar y finalizar el plan.</li>

                    <li>El plan debe ser finalizado para que pase a la fase de seguimiento. El rector debe ser el último usuario de la universidad que verifique el plan con todos los cambios y observaciones.</li>
                  </ul>
